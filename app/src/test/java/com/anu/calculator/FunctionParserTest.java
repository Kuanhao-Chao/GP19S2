...
public class FunctionParserTest {
    ...
    public void testFunctionResult() {
        ...
        testCases.add(new TestCase("", null,false));
        testCases.add(new TestCase(" ", null,false));
        testCases.add(new TestCase("   ", null,false));
        testCases.add(new TestCase("=", null,false));
        testCases.add(new TestCase("==", null,false));
        testCases.add(new TestCase("a", null,false));
        testCases.add(new TestCase("a=", null,false));
        testCases.add(new TestCase("a==", null,false));
        testCases.add(new TestCase("=a", null,false));
        testCases.add(new TestCase("==a", null,false));
        testCases.add(new TestCase("x=y=x", null,false));
        testCases.add(new TestCase("x========yz", null,false));
        testCases.add(new TestCase("x====y====z", null,false));
        testCases.add(new TestCase("x=y=z=w=ɑ=β", null,false));
        testCases.add(new TestCase("x==y", null,false));
        testCases.add(new TestCase("=x=y", null,false));
        testCases.add(new TestCase("x=y=", null,false));
        testCases.add(new TestCase("=x=y=", null,false));
        //        w | x | y | z | ɑ | β | ɣ | Δ
        testCases.add(new TestCase("2+1×2÷3×12 = 9124", Arrays.asList("2+1×2÷3×12", "9124"),true));
        testCases.add(new TestCase("2+1×2÷3×w = 9124", Arrays.asList("2+1×2÷3×w", "9124"),true));
        testCases.add(new TestCase("w+1×3÷3×12 = 9124", Arrays.asList("w+1×3÷3×12", "9124"),true));
        testCases.add(new TestCase("w+x×y÷z×ɑ = 9124", Arrays.asList("w+x×y÷z×ɑ", "9124"),true));
        testCases.add(new TestCase("x=y", Arrays.asList("x", "y"),true));
        testCases.add(new TestCase("x=y    ", Arrays.asList("x", "y"),true));
        testCases.add(new TestCase("    x=y", Arrays.asList("x", "y"),true));
        testCases.add(new TestCase("x    =y", Arrays.asList("x", "y"),true));
        testCases.add(new TestCase("x=     y", Arrays.asList("x", "y"),true));
        testCases.add(new TestCase("x=     y", Arrays.asList("x", "y"),true));
        testCases.add(new TestCase("1×w + 2×x + 3×y + 4×z + 5×ɑ + 6×β + 7×ɣ + 8×Δ =    1÷w + 2÷x + 3÷y + 4÷z + 5÷ɑ + 6÷β + 7÷ɣ + 8÷Δ", Arrays.asList("1×w+2×x+3×y+4×z+5×ɑ+6×β+7×ɣ+8×Δ", "1÷w+2÷x+3÷y+4÷z+5÷ɑ+6÷β+7÷ɣ+8÷Δ"),true));
